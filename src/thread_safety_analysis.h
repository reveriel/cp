...
// SWIG is a tool that parses C++ code and generates scripting interfaces.
// It is used to generate Python, Perl, Ruby, Tcl, Java, C#, D, Go, Lua,
// Octave, R, Scilab, Ocaml and Pike modules for the C/C++ library.
// We don't want to use thread annotations in SWIG interface files.
#define THREAD_ANNOTATION_ATTRIBUTE__(x) __attribute__((x))
#else
#define THREAD_ANNOTATION_ATTRIBUTE__(x) // no-op
#endif

// capability, can be exclusive or shared, is associated with a mutex like
// object, that can be locked and unlocked.
// shared are used for read only access, exclusive for read/write access.
// a thread holds a set of
